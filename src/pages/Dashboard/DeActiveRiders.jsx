...
const DeActiveRiders = () => {
    ...
    const { data: riders = [], isLoading } = useQuery({
        ...
        queryFn: async () => {
            const response = await axiosSecure.get("/riders/de-active");
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: (data) => {
            if (data.deletedCount > 0) {
                ...
                queryClient.invalidateQueries(["deactive-riders"]);
            }
        },
        onError: () => {
                                        ...
                                        <td className="flex gap-2 justify-center">
                                            <button
                                                onClick={() => {
                                                    ...
                                                    document.getElementById("deactive_details_modal").showModal();
                                                }}
